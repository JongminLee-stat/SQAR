...
pdf("coeff_lambda_CNT.pdf", height = 10, width = 15)
par(mfrow = c(1, 1),
    mar = c(6, 6, 6, 6)
)   
plot(x = 1:99 * 0.01, y = coeff[1:99], xlim = c(0, 1),
     xlab = "Quantile level", ylab = "Coefficient", main = "Spatial lagged dependent variable (CNT)", 
     cex.axis = 2, cex.lab = 3, cex.main = 3.5, type = "l", lty = "solid")
dev.off()
